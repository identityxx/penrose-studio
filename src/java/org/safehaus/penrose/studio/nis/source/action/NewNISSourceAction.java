 ...
 */
package org.safehaus.penrose.studio.nis.source.action;
...
public class NewNISSourceAction extends Action {

    Logger log = Logger.getLogger(getClass());

    SourcesNode sourcesNode;

	public NewNISSourceAction(SourcesNode node) {
        this.sourcesNode = node;

        setText("New NIS Source...");
	...
	public void run() {
        try {
            ...
            NISSourceWizard wizard = new NISSourceWizard();
