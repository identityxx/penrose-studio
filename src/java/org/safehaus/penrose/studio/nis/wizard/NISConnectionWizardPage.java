 ...
 */
public class NISConnectionWizardPage extends WizardPage implements ModifyListener {

    public Logger log = LoggerFactory.getLogger(getClass());

    public final static String NAME = "NIS Connection";
    ...
    public NISConnectionWizardPage() {
        super(NAME);

        setDescription("Enter database information.");
    }
