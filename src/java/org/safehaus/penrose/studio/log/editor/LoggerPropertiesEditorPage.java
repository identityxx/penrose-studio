...
public class LoggerPropertiesEditorPage extends FormPage {
    ...
    public LoggerPropertiesEditorPage(LoggerEditor editor) {
        ...
        this.editor = editor;
        this.loggerConfig = editor.loggerConfig;
    }
    ...
    public void refresh() {
        ...
        additivityCheckbox.setSelection(loggerConfig.isAdditivity());
    }
}