 ...
 */
public class ConnectorPropertyPage {
    ...
    public ConnectorPropertyPage(ConnectorEditor editor) {
        this.editor = editor;
        this.connectorConfig = editor.connectorConfig;
    }
	...
	public Composite createPropertiesSection(Composite parent) {
		...
		connectorNameText = toolkit.createText(composite, connectorConfig.getName(), SWT.BORDER);
        gd = new GridData(GridData.FILL_HORIZONTAL);
		connectorNameText.setLayoutData(gd);

        connectorNameText.addModifyListener(new ModifyListener() {
            public void modifyText(ModifyEvent event) {
                connectorConfig.setName(connectorNameText.getText());
                checkDirty();
            }
        });
        ...
        connectorClassText = toolkit.createText(composite, connectorConfig.getConnectorClass(), SWT.BORDER);
        gd = new GridData(GridData.FILL_HORIZONTAL);
        connectorClassText.setLayoutData(gd);

        connectorClassText.addModifyListener(new ModifyListener() {
            public void modifyText(ModifyEvent event) {
                connectorConfig.setConnectorClass(connectorClassText.getText());
                checkDirty();
            }
        });
        ...
        descriptionText = toolkit.createText(composite, connectorConfig.getDescription(), SWT.BORDER);
        gd = new GridData(GridData.FILL_HORIZONTAL);
        descriptionText.setLayoutData(gd);

        descriptionText.addModifyListener(new ModifyListener() {
            public void modifyText(ModifyEvent event) {
                connectorConfig.setDescription(descriptionText.getText());
                checkDirty();
            }
        });
            ...
            public void mouseDoubleClick(MouseEvent event) {
                try {
                    ...
                    if (!oldName.equals(newName)) {
                        connectorConfig.removeParameter(oldName);
                    }

                    connectorConfig.setParameter(newName, newValue);
        ...
        addButton.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent event) {
                try {
                    ...
                    connectorConfig.setParameter(dialog.getName(), dialog.getValue());
            ...
            public void widgetSelected(SelectionEvent event) {
                try {
                    ...
                    for (int i=0; i<items.length; i++) {
                        ...
                        connectorConfig.removeParameter(name);
                    }
