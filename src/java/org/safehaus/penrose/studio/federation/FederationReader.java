...
public class FederationReader implements EntityResolver {
    ...
    public FederationReader() {
        ...
        dtdUrl = cl.getResource("org/safehaus/penrose/studio/federation/federation.dtd");
        digesterUrl = cl.getResource("org/safehaus/penrose/studio/federation/federation-digester-rules.xml");
