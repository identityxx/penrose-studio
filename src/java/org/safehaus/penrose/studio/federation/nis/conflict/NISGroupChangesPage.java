...
public class NISGroupChangesPage extends FormPage {
    ...
    public NISGroupChangesPage(NISEditor editor, NISFederationClient nisFederation) throws Exception {
    ...
    public void refresh() {
        try {
            ...
            SourceClient sourceClient = sourceManagerClient.getSourceClient("penrose_groups");
