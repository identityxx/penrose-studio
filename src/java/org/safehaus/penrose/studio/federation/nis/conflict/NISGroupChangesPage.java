...
public class NISGroupChangesPage extends FormPage {
    ...
    public NISGroupChangesPage(FormEditor editor, NISFederation nisFederation) throws Exception {
    ...
    public NISGroupChangesPage(FormEditor editor, NISDomain domain, NISFederation nisFederation) throws Exception {
    ...
    public void refresh() {
        try {
            ...
            SourceClient sourceClient = partitionClient.getSourceClient("penrose_groups");

            sourceClient.search(request, response);
            //nisFederation.getGroups().search(request, response);
...
/*
                    ...
                    nisFederation.getGroups().add(dn, attributes);
*/
                } catch (Exception e) {
                    log.error(e.getMessage(), e);
                    ErrorDialog.open(e);
        ...
        editButton.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent selectionEvent) {
                try {
                    ...
                    //nisFederation.getGroups().modify(result.getDn(), modifications);
            ...
            public void widgetSelected(SelectionEvent selectionEvent) {
                try {
                    ...
                    for (TableItem ti : items) {
                        ...
                        //nisFederation.getGroups().delete(result.getDn());
                    }
        ...
        showFilesButton.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent selectionEvent) {
                try {
                    ...
                    page.getUidText().setText("");
                    page.getGidText().setText(""+origGidNumber);
        ...
        changeFilesButton.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent selectionEvent) {
                try {
                    ...
                    page.getActionsCombo().setText("Change file GID number");

                    page.getHostsList().selectAll();
                    page.getFromText().setText(""+origGidNumber);
                    page.getToText().setText(""+gidNumber);
        ...
        revertFilesButton.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent selectionEvent) {
                try {
                    ...
                    page.getHostsList().selectAll();
                    page.getFromText().setText(""+gidNumber);
                    page.getToText().setText(""+origGidNumber);
