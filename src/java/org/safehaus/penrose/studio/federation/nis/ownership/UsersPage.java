 ...
 */
public class UsersPage extends FormPage {
        ...
        exportButton.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent selectionEvent) {
                try {
                    ...
                    dialog.setFileName(repositoryConfig.getName()+"-users.txt");
    ...
    public void exportChanges(String path) throws Exception {
        ...
        for (String result[] : getChanges()) {
            String uid = result[0];
            String uidNumber = result[1];
            String globalUidNumber = result[2];

            out.println(uid+","+uidNumber+","+globalUidNumber);
        }
