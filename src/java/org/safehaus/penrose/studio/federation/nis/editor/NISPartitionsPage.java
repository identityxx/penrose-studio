            ...
            public void widgetSelected(SelectionEvent selectionEvent) {
                try {
                    ...
                    for (TableItem ti : items) {
                        ...
                        nisFederation.removePartition(domain);

                        nisFederation.removePartitionConfig(domain);
