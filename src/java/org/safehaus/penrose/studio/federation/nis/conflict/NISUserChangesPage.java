...
public class NISUserChangesPage extends FormPage {
    ...
    public NISUserChangesPage(NISEditor editor, NISFederationClient nisFederation) throws Exception {
    ...
    public NISUserChangesPage(NISUsersEditor editor, FederationRepositoryConfig domain, NISFederationClient nisFederation) throws Exception {
    ...
    public void refresh() {
        try {
            ...
            SourceClient sourceClient = sourceManagerClient.getSourceClient("penrose_users");
