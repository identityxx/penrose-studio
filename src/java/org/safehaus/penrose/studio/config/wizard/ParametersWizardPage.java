 ...
 */
public class ParametersWizardPage extends WizardPage implements SelectionListener, ModifyListener {
    ...
    public ParametersWizardPage() {
        super(NAME);
        setDescription("Enter parameters.");
    }
