 ...
 */
public class SourceBrowserOptionsWizard extends Wizard {
    ...
    public SourceBrowserOptionsWizard() {
        setWindowTitle("Edit Source Browser Options");
    }

    public void addPages() {

        optionsPage = new LDAPConnectionOptionsWizardPage();
        optionsPage.setDescription("Enter source browser options.");
