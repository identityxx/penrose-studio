 ...
 */
public class ServicePropertiesWizardPage extends WizardPage implements ModifyListener {

    public final static String NAME = "Service Properties";
    ...
    public ServicePropertiesWizardPage() {
        super(NAME);
        setDescription("Enter the properties of the service.");
    }
    ...
    public boolean validatePage() {
        ...
        if ("".equals(getClassName())) return false;
        return true;
    }
