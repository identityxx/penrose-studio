 ...
 */
package org.safehaus.penrose.studio.logging.editor;
...
import org.safehaus.penrose.studio.logging.editor.AppenderSelectionDialog;
    ...
    public Composite createAppendersControl(Composite parent) {
        ...
        appendersTable.addMouseListener(new MouseAdapter() {
            public void mouseDoubleClick(MouseEvent mouseEvent) {
                ...
                dialog.setAppenderName(appenderName);
                dialog.open();

                if (dialog.getAction() == LoggerDialog.CANCEL) return;

                appenderName = dialog.getAppenderName();
