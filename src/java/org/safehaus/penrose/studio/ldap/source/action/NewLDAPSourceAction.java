 ...
 */
package org.safehaus.penrose.studio.ldap.source.action;
...
public class NewLDAPSourceAction extends Action {

    Logger log = Logger.getLogger(getClass());

    SourcesNode sourcesNode;

	public NewLDAPSourceAction(SourcesNode node) {
        this.sourcesNode = node;

        setText("New LDAP Source...");
