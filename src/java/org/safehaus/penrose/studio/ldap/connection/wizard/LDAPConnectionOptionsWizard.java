 ...
 */
public class LDAPConnectionOptionsWizard extends Wizard {
    ...
    public LDAPConnectionOptionsWizard() {
        setWindowTitle("Edit LDAP Connection Options");
    }

    public void addPages() {

        optionsPage = new LDAPConnectionOptionsWizardPage();
        optionsPage.setServer(server);
