 ...
 */
public class ConnectionSchemaPage extends ConnectionEditorPage {
    ...
    public ConnectionSchemaPage(ConnectionEditor editor) {
    ...
    public Composite createActionsSection(final Composite parent) {
        ...
        Hyperlink exportSchema = getToolkit().createHyperlink(composite, "Export", SWT.NONE);
    ...
    public Composite createObjectClassesSection(final Composite parent) {
        ...
        objectClassesTable = getToolkit().createTable(composite, SWT.BORDER | SWT.MULTI | SWT.FULL_SELECTION);
