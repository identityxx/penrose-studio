 ...
 */
public class ConnectionBrowserPage extends ConnectionEditorPage implements TreeListener {
    ...
    public ConnectionBrowserPage(ConnectionEditor editor) {
    ...
    public Composite createActionsSection(final Composite parent) {
        ...
        Hyperlink refreshSchema = getToolkit().createHyperlink(composite, "Refresh", SWT.NONE);
    ...
    public Composite createTreeSection(final Composite parent) {
        ...
        tree = getToolkit().createTree(composite, SWT.BORDER | SWT.H_SCROLL | SWT.V_SCROLL);
    ...
    public Composite createEntrySection(final Composite parent) {
        ...
        table = getToolkit().createTable(composite, SWT.BORDER | SWT.MULTI | SWT.FULL_SELECTION | SWT.H_SCROLL | SWT.V_SCROLL);
