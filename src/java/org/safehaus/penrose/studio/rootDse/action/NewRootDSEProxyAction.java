...
import org.safehaus.penrose.studio.rootDse.wizard.RootDSEProxyWizard;
...
public class NewRootDSEProxyAction extends Action {

    Logger log = Logger.getLogger(getClass());

    DirectoryNode directoryNode;

	public NewRootDSEProxyAction(DirectoryNode node) {
        this.directoryNode = node;

        setText("Create Root DSE Proxy...");
