 ...
 */
public class JDBCConnectionEditorInput implements IEditorInput {

    private Partition partition;
    private ConnectionConfig connectionConfig;

    public JDBCConnectionEditorInput(Partition partition, ConnectionConfig connectionConfig) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JDBCConnectionEditorInput)) return false;

        JDBCConnectionEditorInput cei = (JDBCConnectionEditorInput)o;
