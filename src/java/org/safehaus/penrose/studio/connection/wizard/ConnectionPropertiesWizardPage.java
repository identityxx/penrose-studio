 ...
 */
public class ConnectionPropertiesWizardPage extends WizardPage implements ModifyListener {
    ...
    public ConnectionPropertiesWizardPage() {
        super(NAME);
        setDescription("Enter the properties of the connection.");
    }
