...
public class ModuleMethodsPage extends FormPage {
    ...
    public void createFormContent(IManagedForm managedForm) {
        ...
        Composite methodsComponent = createMethodsComponent(methodsSection);
    ...
    public Composite createMethodsComponent(final Composite parent) {

        Composite composite = toolkit.createComposite(parent);
        composite.setLayout(new GridLayout(2, false));

        methodsTable = toolkit.createTable(composite, SWT.BORDER | SWT.FULL_SELECTION | SWT.MULTI);
        ...
        Button executeButton = new Button(buttons, SWT.PUSH);
