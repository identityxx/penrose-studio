...
public class NewPollingConnectorModuleAction extends Action {

    Logger log = Logger.getLogger(getClass());

    ModulesNode node;

    public NewPollingConnectorModuleAction(ModulesNode node) {
        this.node = node;

        setText("New Polling Connector Module...");
