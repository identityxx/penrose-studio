 ...
 */
public class MappingPreScriptWizard extends Wizard {
    ...
    public MappingPreScriptWizard() {
        setWindowTitle("Edit Mapping Pre-Script");
    }

    public void addPages() {

        scriptPage = new MappingScriptWizardPage();
        scriptPage.setDescription("Enter mapping pre-script.");
        scriptPage.setScript(mappingConfig.getPreScript());
    ...
    public boolean performFinish() {
        try {
            mappingConfig.setPreScript(scriptPage.getScript());
