...
import org.safehaus.penrose.studio.schema.wizard.ADSchemaProxyWizard;
import org.apache.log4j.Logger;

public class NewADSchemaProxyAction extends Action {

    Logger log = Logger.getLogger(getClass());

    DirectoryNode directoryNode;

	public NewADSchemaProxyAction(DirectoryNode directoryNode) {
        this.directoryNode = directoryNode;

        setText("Create AD Schema Proxy...");
	...
	public void run() {
        try {
            ...
            ADSchemaProxyWizard wizard = new ADSchemaProxyWizard();
