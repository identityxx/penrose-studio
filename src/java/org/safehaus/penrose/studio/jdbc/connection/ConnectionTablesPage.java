 ...
 */
public class ConnectionTablesPage extends ConnectionEditorPage {
    ...
    public ConnectionTablesPage(ConnectionEditor editor) {
    ...
    public Composite createActionsSection(final Composite parent) {
        ...
        Hyperlink refresh = getToolkit().createHyperlink(composite, "Refresh", SWT.NONE);
    ...
    public Composite createCatalogsSection(Composite parent) {
        ...
        String driver   = getConnectionConfig().getParameter(JDBCAdapter.DRIVER);
        String username = getConnectionConfig().getParameter(JDBCAdapter.USER);
        ...
        mi.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent event) {
                try {
                    ...
                    JDBCSourceWizard wizard = new JDBCSourceWizard(getPartition(), getConnectionConfig(), tableConfig);
    ...
    public void refresh() {
        try {
            ...
            JDBCClient client = new JDBCClient(getConnectionConfig().getParameters());
            client.connect();
